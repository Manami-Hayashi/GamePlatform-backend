...
//
//@AnalyzeClasses(packages = "be.kdg.prog6.playerManagementContext", importOptions = ImportOption.DoNotIncludeTests.class)
//public class ArchitectureTest {
//    private static final String DOMAIN_LAYER = "be.kdg.prog6.playerManagementContext.domain..";
//    private static final String ADAPTER_LAYER = "be.kdg.prog6.playerManagementContext.adapters..";
//    private static final String CORE_LAYER = "be.kdg.prog6.playerManagementContext.core..";
//    private static final String PORT_LAYER = "be.kdg.prog6.playerManagementContext.ports..";
//
//    @ArchTest
...
//        JavaClasses jc = new ClassFileImporter().importPackages("be.kdg.prog6.playerManagementContext");
//
