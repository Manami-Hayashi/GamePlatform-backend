...
@SpringBootTest
@ActiveProfiles("test")
class StartHelloWorldUseCaseImplIntegrationTest extends AbstractDatabaseTest {

    @Autowired
    private StartHelloWorldUseCase startHelloWorldUseCase;
...
//    @Test
//    void shouldStartHelloWorldGameSuccessfully() {
//        // Arrange
//        UUID lobbyId = UUID.randomUUID();
//
//        // Act & Assert
//        Assertions.assertDoesNotThrow(() -> {
//            ReadyUpResponse response = startHelloWorldUseCase.readyUp(lobbyId);
//            Assertions.assertTrue(response.isGameSessionStarted());
//        });
//    }

    @Test
    void shouldFailToStartHelloWorldGame() {
        // Arrange
        UUID lobbyId = null;

        // Act & Assert
        Assertions.assertThrows(InvalidDataAccessApiUsageException.class, () -> startHelloWorldUseCase.readyUp(lobbyId));
    }
}