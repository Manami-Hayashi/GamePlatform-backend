...
//
//@AnalyzeClasses(packages = "be.kdg.prog6.lobbyManagementContext", importOptions = ImportOption.DoNotIncludeTests.class)
//public class ArchitectureTest {
//    private static final String DOMAIN_LAYER = "be.kdg.prog6.lobbyManagementContext.domain..";
//    private static final String ADAPTER_LAYER = "be.kdg.prog6.lobbyManagementContext.adapters..";
//    private static final String CORE_LAYER = "be.kdg.prog6.lobbyManagementContext.core..";
//    private static final String PORT_LAYER = "be.kdg.prog6.lobbyManagementContext.ports..";
//
//    @ArchTest
...
//        JavaClasses jc = new ClassFileImporter().importPackages("be.kdg.prog6.lobbyManagementContext");
//
