...
@Component
public class SessionStartedEventPublisher implements UpdateGameSessionPort, UpdateHelloWorldGameSessionPort {
    ...
    public void updateHWGameSession(GameSession gameSession) {
        LOGGER.info("Publishing GameSessionUpdatedEvent to RabbitMQ");
        GameSessionCreatedEvent event = new GameSessionCreatedEvent(
                gameSession.getSessionId(),
                gameSession.getGameId().id(),
                gameSession.getStartTime(),
