...
@AnalyzeClasses(packages = "be.kdg.prog6.gameManagementContext", importOptions = ImportOption.DoNotIncludeTests.class)
public class ArchitectureTest {
    private static final String DOMAIN_LAYER = "be.kdg.prog6.gameManagementContext.domain..";
    private static final String ADAPTER_LAYER = "be.kdg.prog6.gameManagementContext.adapters..";
    private static final String CORE_LAYER = "be.kdg.prog6.gameManagementContext.core..";
    private static final String PORT_LAYER = "be.kdg.prog6.gameManagementContext.ports..";
    ...
    public void givenApplicationClasses_thenNoLayerViolationsShouldExist() {
        JavaClasses jc = new ClassFileImporter().importPackages("be.kdg.prog6.gameManagementContext");
