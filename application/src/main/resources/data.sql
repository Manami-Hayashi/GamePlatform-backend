...
INSERT INTO store.game (game_id, game_name, price, description) VALUES
                                                                    ...
                                                                    (UUID_TO_BIN('6bf497bd-b0a5-4421-a0af-c2d151bddf1f'), 'Hello World Clicker', 0, 'A clicking game');
...
INSERT INTO lobby_management.player (player_id, name, last_active, lobby_id, game_id) VALUES (UUID_TO_BIN('a7d9b1bc-b94d-4fa1-a1a0-65d7d4359634'), 'Josh', NOW(), UUID_TO_BIN('49b5b7d0-ab1e-11ef-9cd2-0242ac120002'), UUID_TO_BIN('14910372-c39d-7de7-b05a-93f8166cf7af'));
